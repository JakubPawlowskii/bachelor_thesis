...
\renewcommand*{\chapnumfont}{
    ...
    \usefont{T1}{pzc}{b}{n}
    \fontsize{100}{120}\color{pinegreen}\selectfont}
% default number
% \renewcommand*{\chapnumfont}{%
...
% dane promotora
	...
	\begin{center}
		\epigraph{\normalsize 
	I would like to express my sincere gratitude to prof.\ Marcin Mierzejewski for being my
	guide into the world of quantum many-body physics. Without his immense knowledge and willingess
	to help, this work would not have been possible.\\
	\vspace*{0.5cm}
	I also own my heartfelt appreciation to prof.\ Katarzyna Sznajd-Weron who
	...
	\input{Chapters/iom.tex}
	\cleardoublepage{}

	\input{Chapters/decay.tex}
	\cleardoublepage{}
	...
	\input{Chapters/appendix_integrability.tex}
	\cleardoublepage{}
	\input{Chapters/appendix_spectral.tex}
	\cleardoublepage{}
	\input{Chapters/appendix_energy_current.tex}
	\cleardoublepage{}
	\input{Chapters/appendix_orthonormality.tex}
	\cleardoublepage{}
