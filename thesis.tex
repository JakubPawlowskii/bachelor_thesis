...
% dane promotora
	...
	\abstract{\noindent
		...
		number of (quasi)local integrals of motions. In this work we investigate a class
		...
		After shifting away from these values, the degeneracy is lifted already in first-order
		perturbation theory, leading to linear scaling.
		\textcolor{red}{Corrected with Writefull}
	}
	\begin{quotation}
