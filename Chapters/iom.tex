...
\textcolor{blue}{Here insert the plot of lambdas for energy current and different L}.
After taking the thermodynamic limit of the eigenvalue of \(K\) matrix 
corresponding to the energy current, we see that it equals precisely to unity. Thus, according
to Definition~\ref{def:classification}, it is a local integral of motion. 
