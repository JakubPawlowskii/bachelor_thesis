...
namespace operators
{
    ...
    uint max_supp = 4;                                         // maximal support of operators
...
int main()
{
    ...
    */
    ...
    if (max_supp == 4)
    {
        ...
        {
            op_def = append_ops(0, 7, op_def); // L = 8

            coeffs_vals = {0.353553};
        ...
        {
            op_def = append_ops(0, 9, op_def); // L = 8

            coeffs_vals = {-0.316228};
            coeffs.resize(coeffs_vals.size() * sites);
        ...
        if ((sites == 12) && delta > 0.0)
        {
            ...
            op_def = append_ops(0, 11, op_def); // L = 8
        ...
        if ((sites == 14) && delta > 0.0)
        {
            ...
            op_def = append_ops(0, 13, op_def); // L = 8
         ...
         if ((sites == 16) && delta > 0.0)
        {
            ...
            op_def = append_ops(0, 15, op_def); // L = 8
    ...
    if ((sites == 8) && delta < 0.0)
    {
        op_def = append_ops(48, 55, op_def); // L = 8
        op_def = append_ops(152, 159, op_def);
        op_def = append_ops(208, 215, op_def);

        coeffs_vals = {0.28429, -0.148626, -0.148626};
        coeffs.resize(coeffs_vals.size() * sites);
    ...
    if ((sites == 10) && delta < 0.0)
    {
        op_def = append_ops(60, 69, op_def); // L = 8
        op_def = append_ops(190, 199, op_def);
        op_def = append_ops(260, 269, op_def);

        coeffs_vals = {-0.254381, 0.132835, 0.132835};
        coeffs.resize(coeffs_vals.size() * sites);
    ...
    {
        norm_correction = 10.0/12.0;
        op_def = append_ops(72, 83, op_def); // L = 8
        op_def = append_ops(228, 239, op_def);
        op_def = append_ops(312, 323, op_def);
    ...
    {
        norm_correction = 10.0/14.0;
        op_def = append_ops(84, 97, op_def); // L = 8
        op_def = append_ops(266, 279, op_def);
        op_def = append_ops(364, 377, op_def);
    ...
    {
        norm_correction = 10.0/16.0;
        op_def = append_ops(96,111, op_def); // L = 8
        op_def = append_ops(304,319, op_def);
        op_def = append_ops(416,431, op_def);
  ...
  if (max_supp == 3)
    ...
    if ((sites == 10) && delta < 0.0)
    {
        op_def = append_ops(60, 69, op_def); 
    ...
    if ((sites == 12) && delta < 0.0)
    {
        ...
        op_def = append_ops(72, 83, op_def); 
    ...
    {
        norm_correction = 12.0/14.0;
        op_def = append_ops(84, 97, op_def); 
    ...
    cout << std::setprecision(17) << eigval << "\n";
