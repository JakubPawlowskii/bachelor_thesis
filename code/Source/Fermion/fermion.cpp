...
{
    constexpr uint sites = 2;        //var1     // no. of sites
...
namespace operators
{
    ...
    uint max_supp = 2;                                         // maximal support of operators
...
int main()
{
    ...
    std::cout << std::setprecision(15) << eigenval(0) << std::endl;
    generate_operators();
    ...
    arma::mat op1 = generate_op_matrix(0);
    op1.print();
    std::cout << std::endl;
    op1 = generate_op_matrix(2);
    op1.print();
    std::cout << std::endl;
    op1 = generate_op_matrix(4);
    op1.print();
    std::cout << std::endl;
    op1 = generate_op_matrix(6);
    op1.print();
    std::cout << std::endl;
