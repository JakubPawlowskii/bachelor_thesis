...
# alpha = [0.2,0.3,0.4]
idx = (taus_all < 100000) & (taus_all > 0) 
#===================== Left upper panel ============================================
scaling_factor = 2
# alpha = [0.6]
taus = taus_all[idx]
...
ax2.text(text_x+0.05,text_y-0.07,r'extrap. from',horizontalalignment='center',verticalalignment='center', transform=ax2.transAxes,zorder=6)
ax2.text(text_x-0.06,text_y-0.12,r'$L=11,12,13,14$',horizontalalignment='left',verticalalignment='center', transform=ax2.transAxes,zorder=6)
# ax2.set_xlim([-0.5,7])
...
fig_name = 'R1_energy_current_no_alpha'
