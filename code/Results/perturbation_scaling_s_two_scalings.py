...
# def scaling_quality(x,R1):
#     distance = np.zeros((len(R1[:,0]),len(R1[:,0])))
#     for i in range(len(R1[:,0])):
#         for j in range(len(R1[:,0])):
#             points1 = np.array([i for i in zip(x[i,:],R1[i,:])])
#             points2 = np.array([i for i in zip(x[j,:],R1[j,:])])
#             distance[i,j] = np.sqrt(np.sum((points1-points2)**2))
#     print(distance)
...
R1 = get_R1(t,-0.5,[12],mode,alpha,taus,idx)
...
# ax1.text(text_x+0.09,text_y+0.6,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax1.transAxes,zorder=6)
# ax1.text(text_x+0.09,text_y+0.53,r'$L = 12$',horizontalalignment='left',verticalalignment='center', transform=ax1.transAxes,zorder=6)
ax1.text(text_x-0.04,text_y,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax1.transAxes,zorder=6)
ax1.text(text_x-0.04,text_y-0.07,r'$L = 12$',horizontalalignment='left',verticalalignment='center', transform=ax1.transAxes,zorder=6)
...
ax2.text(text_x-0.04,text_y,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax2.transAxes,zorder=6)
ax2.text(text_x-0.04,text_y-0.07,r'$L = 12$',horizontalalignment='left',verticalalignment='center', transform=ax2.transAxes,zorder=6)
# ax2.set_xlim([-0.5,7])
...
# ax3.text(text_x+0.09,text_y+0.6,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
# ax3.text(text_x+0.09,text_y+0.53,r'$L = 14$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
ax3.text(text_x-0.04,text_y,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
ax3.text(text_x-0.04,text_y-0.07,r'$L = 14$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
...
ax4.text(text_x-0.04,text_y,r'$\Delta = -0.5$',horizontalalignment='left',verticalalignment='center', transform=ax4.transAxes,zorder=6)
ax4.text(text_x-0.04,text_y-0.07,r'$L = 14$',horizontalalignment='left',verticalalignment='center', transform=ax4.transAxes,zorder=6)
...
for i,ax in enumerate(axes):
    ...
    if ax == ax3 or ax == ax4:
        if scaling_factors[i] == 1:
            ax.set_xlabel(r'$\frac{1}{\tau |\alpha|}$',fontsize=24)
        elif scaling_factors[i] == 0:
            ax.set_xlabel(r'$\frac{1}{\tau}$',fontsize=24)
        else:
            ax.set_xlabel(r'$\frac{1}{\tau |\alpha|^{'+str(scaling_factors[i])+'}}$',fontsize=24)
    ax.tick_params(axis='both', which='major', labelsize=16)

path_to_fig = 'plots/paper_plots/'
fig_name = 'R1_spin_delta_-0.5_two_alphas_neg_full'
