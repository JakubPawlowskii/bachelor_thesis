...
def plot_R1(ax,R1,x,alpha,mode,markers):
    for i,a in enumerate(alpha):
        ...
        if mode == 'ec':
            ...
            ax.plot(x[i,:],R1[i,:],marker,markersize=markersize,label=label,markevery=markevery)
        else:
            label = r'$\alpha = ' + r'{:.2f}'.format(a) + r'$'
            ax.plot(x[i,:],R1[i,:],marker,markersize=markersize,label=label,markevery=markevery,markeredgecolor='k',markeredgewidth=0.3)
...
idx_su2 = (taus_all_su2 < 10000000) & (taus_all_su2 > 0.4) 
...
sl3 = slice(midpoint1+midpoint2+1,-1,3)
...
ax1.set_ylabel(r'$R_1$',fontsize=labelssize)
...
# ax3.set_ylabel(r'$R_1$',fontsize=labelssize)

# ax3.text(text_x,text_y,r'$\Delta = 1.0$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
# ax3.text(text_x,text_y-0.06,r'$L = 14$',horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6)
# ax3.text(text_x,text_y-0.12,r"$H' = \alpha \sum_{i=1}^L S_{i}^z S_{i+1}^z $",horizontalalignment='left',verticalalignment='center', transform=ax3.transAxes,zorder=6,fontsize=textsize)
...
# ax4.text(text_x,text_y,r'$\Delta = 1.0$',horizontalalignment='left',verticalalignment='center', transform=ax4.transAxes,zorder=6)
# ax4.text(text_x,text_y-0.06,r'$L = 14$',horizontalalignment='left',verticalalignment='center', transform=ax4.transAxes,zorder=6)
...
fig_name = 'R1_spin_different_perturbations'
